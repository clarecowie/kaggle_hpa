...
class Darknet(nn.Module):
    ...
    def __init__(self, num_blocks:Collection[int], num_classes:int, nf=32, se=False, nf_in=3, head=True):
        ...
        if head: layers += [nn.AdaptiveAvgPool2d(1), Flatten(), nn.Linear(nf, num_classes)]
